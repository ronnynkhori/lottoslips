      ...
      <header className="hero">
        <div className="hero-top">
          <div>
            ...
            <p>
              Always builds the four 20-folds — Team to Score, Over 1.5, Under 4.5, Double Chance —
              tracks results, suggests rebets after early losses, and ranks the best market.
            </p>
          </div>
